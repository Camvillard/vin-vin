...
carpineto = Wine.create!(
  ...
  accords: 'une tartinade de poivrons grillés',
...
hungaria = Wine.create!(
  ...
  accords: 'des frites de patates douce',
...
folonari = Wine.create!(
  ...
  accords: 'des bruschettas aux tomates',
...
masi = Wine.create!(
  ...
  accords: 'des falafels par milliers',
...
zonin = Wine.create!(
  ...
  accords: "plein d'oignons caramélisés",
